...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://3do61nvjua.execute-api.us-east-1.amazonaws.com/coconut';
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Accept'], ['body']);
        ...
        var searchGetRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Accept']),
    ...
    apigClient.sttPut = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'file_name'], ['body']);
        
        var sttPutRequest = {
            verb: 'put'.toUpperCase(),
            path: pathComponent + uritemplate('/stt').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type', ]),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['file_name']),
            body: body
        };
        
        
        return apiGatewayClient.makeRequest(sttPutRequest, authType, additionalParams, config.apiKey);
    };
